...
- **Bytesize-specific overrides**:
  ...
  - `useReducedMotion()` branch — under reduced motion, cards mount in their final stacked layout with zero rotation and unit scale; springs collapse to instant. (DESIGN.md §9.)
